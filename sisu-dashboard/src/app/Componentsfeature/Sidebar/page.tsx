...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64  h-screen bg-[#18315b] flex flex-col items-center py-8 text-xl">
      ...
      <nav className="flex flex-col space-y-8 w-full items-center">
        ...
        <a
          ...
          className={`flex items-center space-x-4 w-full px-8 py-2 ${
            active === 'home' ? 'text-[#FBBC05]' : 'text-white'
          }`}
        >
        ...
        <a
          ...
          className={`flex items-center space-x-4 w-full px-8 py-2 ${
            active === 'teachers' ? 'text-[#FBBC05]' : 'text-white'
          }`}
        >
        ...
        <a
          ...
          className={`flex items-center space-x-4 w-full px-8 py-2 ${
            active === 'assessment' ? 'text-[#FBBC05]' : 'text-white'
          }`}
        >
        ...
        <a
          ...
          className={`flex items-center space-x-4 w-full px-8 py-2 ${
            active === 'trainers' ? 'text-[#FBBC05]' : 'text-white'
          }`}
        >
